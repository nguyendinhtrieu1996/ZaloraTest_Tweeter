...
class TextTestCase {
    ...
    static let textOver50CharacterDoNotContainWhiteSpace = "2323 0349209320932093209320932093209320932039203920392"
    static let textOver50Character = "I can't believe Tweeter now supports chunking my messages, so I don't have to do it myself."
    static let mediumText = """
