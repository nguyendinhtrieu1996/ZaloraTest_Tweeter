...
class TextTestCase {
    static let textGreate50CharacterDoNotContainWhiteSpace = "2323 0349209320932093209320932093209320932039203920392"
    static let textLower50CharacterDoNotContainWhiteSpace = "2323 03492093209320"
    static let text10Character = "0123456789"
    static let text50Character = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"
    static let textSplitTwoParts = "I can't believe Tweeter now supports chunking my messages, so I don't have to do it myself."
    static let textSplit26Parts = """
